			...
			<div id="tab1" class="tab_content">
				<table class="tablesorter" cellspacing="0" style="margin:0">
					...
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "暂无新闻" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			    				...
			    				<td><input type="image" src="http://localhost/news_publish/img/images/icn_edit.png" title="Edit" onclick="window.location.href='index.php?c=admin&a=newsedit&id=<?php echo ($vo["id"]); ?>'"><input type="image" src="http://localhost/news_publish/img/images/icn_trash.png" title="Trash" onclick="window.location.href='index.php?c=admin&a=newsdel&id=<?php echo ($vo["id"]); ?>'"></td>
